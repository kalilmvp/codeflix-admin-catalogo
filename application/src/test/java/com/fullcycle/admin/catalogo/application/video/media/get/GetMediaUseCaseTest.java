...
public class GetMediaUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenValidIdAndType_whenIsValidCmd_shouldRetrieveIt() {
        // given
    ...
    @Test
    public void givenValidIdAndType_whenNotFound_shouldReturnNotFoundException() {
        // given
        final var expectedId = VideoID.unique();
        final var expectedType = Fixture.Videos.mediaType();
    ...
    @Test
    public void givenValidIdAndType_whenTypeNotFound_shouldReturnNotFoundException() {
        // given
        final var expectedId = VideoID.unique();
        final var expectedErrorMessage = "Media type ANYTYPE does not exist";

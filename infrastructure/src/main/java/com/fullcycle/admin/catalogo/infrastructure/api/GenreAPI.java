...
public interface GenreAPI {
  ...
  @GetMapping(value = "{id}",
            produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(summary = "Get unique genre")
  @ApiResponses(value = {
  ...
  GenreResponse getById(@PathVariable("id") final String id);

  @PutMapping(value = "{id}",
              consumes = MediaType.APPLICATION_JSON_VALUE,
              produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(summary = "Update unique genre")
  @ApiResponses(value = {
          @ApiResponse(responseCode = "200", description = "Genre updated successfully"),
          @ApiResponse(responseCode = "422", description = "Genre was not found"),
          @ApiResponse(responseCode = "500", description = "Internal Server Error"),
  })
  ResponseEntity<?> updateById(@PathVariable("id") final String id, @RequestBody UpdateGenreRequest input);

  @DeleteMapping(value = "{id}")
  @ResponseStatus(HttpStatus.NO_CONTENT)
  @Operation(summary = "Delete unique genre")
  @ApiResponses(value = {
